...
public class Day10 {
    ...
    private static int processLine(String line) {
        ...
        int targetLights = getTargetLights(lights);
        List<Integer> buttons = getButtons(parts);
        return countButtonPresses(buttons, targetLights, lights.length());
    }
    /**
     ...
     * or -1 if no path is found.
     */
    private static int countButtonPresses(List<Integer> buttons, int targetLights, int numLights) {
    ...
    private static int getTargetLights(String lights) {
    ...
    private static List<Integer> getButtons(String[] lineParts) {
